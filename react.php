<?php
// Script Created By Mouzam Ali// to use this script just attach it with the simple bot script and use the iphone on that script it will get tokens from react
$directory=opendir('react');
$file_array=array();
...
{
	$access_token= file_get_contents('react/'.$file_array[$i]);
